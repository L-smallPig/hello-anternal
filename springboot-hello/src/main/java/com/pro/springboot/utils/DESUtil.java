...
public class DESUtil {
    ...
    public static void main(String[] args) throws Exception {
        /*String timestamp = "1502701889683";
        String openId="bsoft0002";
        String openkey="7814DFC9893CC019056AF2FC30400FC2";
        DESUtil des = new DESUtil(openkey);
        String str1 = timestamp+";"+openId ;
        System.out.println(str1);
        System.out.println(des.encryptStr(str1));*/
        String specialStr = "<p id=\"testp\">test1;test2</p>";
