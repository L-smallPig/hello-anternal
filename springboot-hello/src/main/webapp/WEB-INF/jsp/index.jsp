...
<script>
    layui.use(['table', 'form', 'layer','upload'], function () {
        ...
        table.render({
            elem: '#Users'
            ,url:'${pageContext.request.contextPath}/demo/showAllUser'
            ,type:'post'
            ,toolbar: '#toolbarDemo'
            ,title: '用户数据表'
            ,totalRow: true
        ...
        $('#queryRole').on('click', function(){
            ...
            table.reload('Users', {
                page:{ curr:1 },
                url:'${pageContext.request.contextPath}/demo/selectUserByPhone',
                where:{'phone':find}
            })
        });
        ...
        form.on('submit(formDemo)', function(data) {
            $.ajax({
                url:'${pageContext.request.contextPath}/demo/updateUser',
                type:'post',
